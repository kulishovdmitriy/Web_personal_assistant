...
@router.put("/update_user/", response_model=ResponseUserSchema, status_code=status.HTTP_202_ACCEPTED)
...
@router.delete(f"/delete_user/", status_code=status.HTTP_200_OK)
